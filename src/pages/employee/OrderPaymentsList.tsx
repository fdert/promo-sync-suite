        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-sm text-muted-foreground">مدفوع جزئياً</p>
                <p className="text-lg font-bold text-yellow-600">{partiallyPaidOrders}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-lg font-bold text-red-600">{unpaidOrders}</p>
              </div>
            </div>
          </CardContent>
        </Card>
