      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="mt-6">
          <div className="bg-white p-8 border rounded-lg shadow-sm" dir="rtl">
            ...
            {/* Customer Info */}
            <div className="mb-8">
              <h3 className="text-lg font-semibold text-gray-800 mb-3">بيانات العميل:</h3>
            ...
            <div className="mb-8">
              <table className="w-full border-collapse border border-gray-300">
                <thead className="bg-gray-100">
                  <tr>
                    <th className="border border-gray-300 p-3 text-right">البند</th>
                ...
                <tbody>
                  {items.map((item, index) => (
                    <tr key={index}>
                      ...
                      <td className="border border-gray-300 p-3 text-center">{item.total_amount.toFixed(2)} ر.س</td>
                    </tr>
                  ))}
                </tbody>
              </table>
