-- إدراج خطط الاشتراك الافتراضية بالحقول الصحيحة
INSERT INTO public.subscription_plans (
    ...
    sort_order,
    max_agencies,
    max_customers_per_agency
) VALUES
('Basic Plan', 'الباقة الأساسية', 'مناسبة للوكالات الصغيرة والناشئة', 299, 'monthly', 
'["إدارة العملاء", "إدارة المشاريع الأساسية", "الفواتير", "التقارير الأساسية", "دعم فني عبر البريد"]'::jsonb, 
5, 100, 5, false, 1, 1, 100),

('Professional Plan', 'الباقة المتوسطة', 'مناسبة للوكالات المتوسطة', 599, 'monthly',
...
15, 500, 20, true, 2, 1, 500),

('Enterprise Plan', 'الباقة المتقدمة', 'مناسبة للوكالات الكبيرة والمؤسسات', 999, 'monthly',
