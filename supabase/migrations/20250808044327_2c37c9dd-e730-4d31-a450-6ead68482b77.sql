-- تحديث دالة معالجة وإرسال الحملات الجماعية لاستخدام أرقام الهواتف الصحيحة
...
BEGIN
    ...
    IF campaign_record.target_type = 'all' THEN
        ...
        AND LENGTH(COALESCE(c.whatsapp_number, c.phone)) >= 10;
    ...
    BEGIN
        ...
        WHERE webhook_type = 'bulk_campaign' AND is_active = true
        LIMIT 1;
