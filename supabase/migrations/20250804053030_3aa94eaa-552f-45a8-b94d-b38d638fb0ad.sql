-- حذف الـ view الموجود وإعادة إنشاؤه
DROP VIEW IF EXISTS customer_order_balances;

-- إنشاء view جديد لحساب أرصدة العملاء من الطلبات
CREATE VIEW customer_order_balances AS
SELECT 
    c.id as customer_id,
