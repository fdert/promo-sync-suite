-- حذف جميع الـ triggers أولاً لحل مشكلة التبعية
...
-- الآن حذف الدوال القديمة
DROP FUNCTION IF EXISTS send_evaluation_link_on_completion() CASCADE;

-- إنشاء الدالة الجديدة التي تُنشئ evaluation فقط بدون إرسال
