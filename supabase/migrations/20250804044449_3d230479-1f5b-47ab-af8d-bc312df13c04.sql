...
-- تحديث الـ triggers لتعمل مع النظام الجديد
DROP TRIGGER IF EXISTS update_accounts_receivable_on_payment_change ON payments;
DROP TRIGGER IF EXISTS update_accounts_receivable_on_invoice_change ON invoices;
