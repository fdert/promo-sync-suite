-- تحديث دالة إرسال إشعارات المتابعة لحفظ الرسائل بحالة pending
...
BEGIN
    ...
    -- حفظ رسالة المتابعة الداخلية بحالة pending للمعالجة اللاحقة
    ...
    -- استدعاء function معالجة الإشعارات تلقائياً
    PERFORM pg_notify('process_follow_up_notifications', NEW.id::text);
