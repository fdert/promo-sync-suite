...
-- إضافة القوالب المفقودة لرسائل الواتس آب
INSERT INTO public.message_templates (template_name, template_content, description, is_active) 
VALUES 
...
سيتم إعلامك عند انتهاء كل مرحلة من مراحل العمل. شكراً لثقتك! 💪', 'رسالة عند بدء تنفيذ الطلب', true),
...
شكراً لصبرك وثقتك بخدماتنا! 🙏', 'رسالة عند مراجعة الطلب', true)
