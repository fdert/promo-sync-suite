-- إنشاء القيود المحاسبية المفقودة للمدفوعات
-- أولاً: إنشاء حسابات النقدية والبنك إذا لم تكن موجودة
INSERT INTO public.accounts (account_name, account_type, description)
VALUES 
  ('البنك', 'أصول', 'الحسابات البنكية')
...
WHERE NOT EXISTS (
  ...
  AND ae.reference_id = pd.payment_id
