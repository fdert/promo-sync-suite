-- إزالة جميع الـ triggers والدوال المكسورة
DROP TRIGGER IF EXISTS sync_accounts_after_order_change_trigger ON orders;
DROP TRIGGER IF EXISTS sync_accounts_after_payment_trigger ON payments;
