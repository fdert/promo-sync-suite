...
-- إنشاء unique constraint على accounts
ALTER TABLE accounts ADD CONSTRAINT accounts_name_type_unique UNIQUE (account_name, account_type);

-- التأكد من وجود الحسابات الأساسية (استخدام ON CONFLICT مع الconstraint الجديد)
