-- إدراج خطط الاشتراك الافتراضية مع الحقول الصحيحة
INSERT INTO public.subscription_plans (name, description, price, billing_period, features, max_users, max_orders, max_storage_gb, is_popular, sort_order) VALUES
